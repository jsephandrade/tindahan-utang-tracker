...
const CustomerManagement = () => {
  ...
  const handleAddCustomer = () => {
    ...
    addCustomer({ ...customerForm, address: "" });
    resetForm();
  ...
  const handleEditCustomer = () => {
    ...
    updateCustomer(editingCustomer.id, { ...customerForm, address: editingCustomer.address || "" });
    resetForm();
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="max-w-md">
          <Input
            ...
            className="border-orange-200 focus:border-orange-400 bg-white/70 backdrop-blur-sm"
          />
        </div>
        ...
        <div className="space-y-4">
          {filteredCustomers.length === 0 ? (
            ...
            filteredCustomers.map((customer) => {
              ...
              return (
                <Card key={customer.id} className="bg-white/90 backdrop-blur-sm border-orange-100 hover:shadow-xl hover:border-orange-200 transition-all duration-300 overflow-hidden">
                        ...
                        <div>
                          ...
                          <div className="space-y-2">
                            {utangHistory.slice(0, 3).map((record) => {
                              ...
                              return (
                                <div key={record.id} className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-3 border border-gray-200">
